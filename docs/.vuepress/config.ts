...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'LiuShuixiu', // 导航栏右侧生成Github链接
    ...
    bodyBgImg: '/img/bg_2.webp', // body背景大图，默认无。 单张图片 String | 多张图片 Array, 多张图片时隔bodyBgImgInterval切换一张。
    ...
    indexImg: {
      ...
      desc: ["关山难越，谁悲失路之人", "萍水相逢，尽是他乡之客"],  // 多个描述，如果填写则覆盖 config.js 的 description，不填写默认读取 config.js 的 description，descFade 为 true 生效
    ...
    author: {
      name: 'LiuShuixiu', // 必需
      link: 'https://github.com/LiuShuixiu', // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'LiuShuixiu | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a> ', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
